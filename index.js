...
app.get('/',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/index.html')})
app.get('/p',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/e/play.html')})
app.get('/l',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/loose.html')})
app.get('/w',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/win.html')})
app.get('/c',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/p/choice.html')})
app.get('/r',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/p/random.html')})
app.get('/see',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/p/core.html')})
...
`)})
app.get('/s',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/p/single.html')})
app.get('/s/s',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/shop.html')})
app.get('/s/json',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/shop.json')})
app.get('/edit',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/e/edit.html')})
app.get('/e',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/e/hub.html')})
app.get('/t/1',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/t/1.html')})
app.get('/t/2',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/t/2.html')})
app.get('/t/3',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/t/3.html')})
app.get('/t/4',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/t/4.html')})
app.get('/t/5',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/t/5.html')})
app.get('/g/c',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/setup.html')})
app.get('/g/p',function(req, res){res.sendFile('/users/27cadem/desktop/game/game/p/multi.html')})
